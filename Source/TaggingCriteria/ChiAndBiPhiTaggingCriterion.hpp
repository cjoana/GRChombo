...
#include "BiScalarField.hpp"      // Changed for BiScalarField
#include "Tensor.hpp"
  ...
  public:
    ...
    template <class data_t> void compute(Cell<data_t> current_cell) const
    {
        ...
        FOR2(idir, jdir)
        {
            ...
            mod_d2_phi2 += d2.Pi2[idir][jdir] * d2.Pi2[idir][jdir] +
        ...
        data_t criterion_phi2 = m_dx / m_threshold_phi * sqrt(mod_d2_phi2);

        data_t criterion = simd_max(criterion_chi, criterion_phi);

        criterion = simd_max(criterion, criterion_phi2);
